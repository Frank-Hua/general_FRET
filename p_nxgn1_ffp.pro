...
print, ""
openr, 1, "C:\Users\frank\Downloads\tir data\rough.map"
         ...
         if x eq 0 then begin
          if y eq 0 then begin
              ...
              if quality eq 1 then begin
                 ...
                 back(no_good) = 0 ; baseline subtraction will be done in ap
                 no_good = no_good + 1
                 good(0,no_good) = xf
                 good(1,no_good) = yf
                 back(no_good) = 0 ; baseline subtraction will be done in ap
...
; if ".pks" is provided, then do not overwrite the file
openr, 1, run + ".pks", ERROR = err
